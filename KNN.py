...
X = np.array([[0.3, 1], [0.5, 4.5], [1, 2.3], [1.4, 1.9], [1.7, 8.9], [2, 4.1], [3.3, 7], [3.5, 1.5], [4, 6.3],
              [4.4, 1.9], [5.7, 2.9], [6, 7.1]])
...
# At this point it's going to calculate the Euclidean-distance
classifier.fit(X, y)
